...
const Sidebar=({onOptionClick})=> {
  ...
  <div className="p-4">
    ...
    <ul>
      ...
      <li className="mb-2 cursor-pointer hover:bg-gray-700 px-4 py-2 rounded-lg" onClick={() => { onOptionClick('Blood') }}>Request</li>
...
const  RightPanel=({selectedOption})=> {
    return (
      <div>
          ...
          {selectedOption==='Blood'&& <div><Blood/></div> }
    ...
    <div className="flex h-screen">
      ...
      <div className="flex flex-col flex-1">
        <div className="bg-gray-100 py-6 px-8">
          <h1 className="text-2xl font-bold text-gray-800">Welcome to X to Infinity</h1>
        </div>
